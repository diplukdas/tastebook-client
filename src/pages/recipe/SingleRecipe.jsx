        ...
        <section className="box flex flex-col gap-8">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="basis-2/3 flex flex-col gap-2">
              ...
              {/* Recipe time & cals */}
              <div className="flex flex-col sm:flex-row gap-2 justify-between w-2/3 mx-auto">
                ...
                <div className="flex flex-col gap-1 items-center">
                  <MdCategory className="text-5xl text-gray-800" />
                  <h3 className="font-bold text-xl text-primary">Category</h3>
                  <p>{data?.category}</p>
                </div>
              </div>
            </div>
